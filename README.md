The safehouse algorithm was used to identify if the adversary was conducting attach behavior to the safehouse. The data sources used from elasticsearch was:
